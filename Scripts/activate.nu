...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ssrir\Codecademy Projects\Portfolio\recipe-fetcher'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ssrir\Codecademy Projects\Portfolio\recipe-fetcher\Scripts\deactivate.nu'
